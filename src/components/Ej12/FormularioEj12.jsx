...
const FormularioEj12 = () => {
  ...
  const getAllNotices = async () => {
    const response = await fetch(
      `https://newsapi.org/v2/top-headlines?category=${filterNotice}&country=${filterCountry}&apiKey=21cdd4bb73c84f6c89eb0ac77fec4ca2`
    );
    ...
    <>
      ...
      <Container>
        <Form>
          ...
          <Form.Label className="mt-3">Seleccione el país</Form.Label>
          <Form.Select
            aria-label="Default select example"
            className="w-50"
